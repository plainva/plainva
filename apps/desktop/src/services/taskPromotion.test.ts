...
const DB_LABELS = { viewTable: "Tabelle", viewBoard: "Board", viewTimeline: "Zeitleiste", doneKey: "erledigt", dueKey: "frist", statusOptions: ["Offen", "In Arbeit", "Erledigt"] as [string, string, string] };
