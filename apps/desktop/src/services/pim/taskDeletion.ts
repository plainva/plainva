import { UndoSendQueue, secondsLeft, UNDO_SEND_MS } from "@plainva/ui/mail";
import { toast, readProviderTaskAnchor, type ProviderTaskAnchor } from "@plainva/ui";
...
if (typeof window !== "undefined") {
  // Cancel, not flush — see decision 2 above.
