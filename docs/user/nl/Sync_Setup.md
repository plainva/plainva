...
**Accounts op al je apparaten** bestaat uit drie stappen die op elkaar voortbouwen. **1 · Versleuteling**: beschermt wat tussen apparaten reist, maar draagt zelf niets over. **2 · Instellingen en accounts**: zet kluisinstellingen *en je accounts* (agenda’s, postvakken, agendaselectie) als klein bestand in de kluis. **3 · Aanmeldingen meenemen**: neemt daarnaast statische IMAP- en CalDAV-wachtwoorden versleuteld mee. Stap 3 kan pas aan als stap 2 draait — een wachtwoord kan alleen naar een account dat het apparaat al kent. Niet meegenomen: apparaatspecifieke paden en OAuth-aanmeldingen (Microsoft, Google); hun tokens zijn apparaatgebonden, dus het account verschijnt op het nieuwe apparaat en heeft daar één keer **Aanmelden** nodig.
