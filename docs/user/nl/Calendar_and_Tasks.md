...
- **RSVP en reacties**: ben je voor een afspraak uitgenodigd, dan kun je in de dialoog **Accepteren**, als **Voorlopig** markeren of **Weigeren** — Plainva stuurt je reactie via de provider (Google/Microsoft/CalDAV). De **deelnemerslijst** toont wie heeft geaccepteerd of geweigerd (het terugkanaal). Uitnodigingen per e-mail naar willekeurige adressen versturen gebeurt via de mail-client.
