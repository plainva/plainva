...
De mobiele app draait als **open test** in Google Play. Op **Android** kom je er direct in: open de testlink via [plainva.com/android-beta](https://plainva.com/android-beta), tik op **Tester worden** en installeer de app vanuit Google Play — geen uitnodiging en geen groep nodig. Plainva staat ook gewoon in de Play Store. Op **iPhone** en **iPad** is TestFlight openbaar: open [https://testflight.apple.com/join/ZRSEfZBn](https://testflight.apple.com/join/ZRSEfZBn) op het apparaat, installeer TestFlight als daarom wordt gevraagd, en Plainva installeert vanaf daar.
...
- **Alle gebieden** bereik je altijd via het **gebiedenblad**: via **Gebieden** in de balk of door **lang op de balk te drukken**. Het toont JOUW indeling — eerst de gebieden van de balk, dan de rest, in de volgorde die jij koos —, markeert het huidige en leidt onderaan meteen naar **Navigatiebalk indelen…**. Tags, bladwijzers en recent geopend zijn geen eigen gebieden meer; die staan onder **Notities**.
- **Navigatiebalk instellen:** **Instellingen** → **Balken en gebieden**. Met **−**/**+** bepaal je hoeveel werkvlakken de balk toont (2–4, met live voorbeeld). Elke regel reageert: tikken haalt het gebied in de balk of eruit, het **oog** ernaast zegt wat geldt, en de **greep** herschikt door slepen — aan de boven- en onderrand schuift de lijst mee, dus één beweging is genoeg. Verbergen verliest niets: wat niet in de balk staat, blijft via **Gebieden** bereikbaar. Verlaat het geopende gebied de balk, dan springt de app naar het eerste zichtbare. Dezelfde balk kun je ook **op de desktop** indelen (Instellingen → Vault → Balken en gebieden); met instellingensynchronisatie reist de indeling mee tussen je apparaten.
...
- **＋** zweeft als ronde knop boven de balk en opent snel aanmaken in twee groepen: notitie, "Vanuit sjabloon…", dagnotitie, journaalitem, map, database — en daaronder afspraak en taak, die in de agenda en de takenlijst worden aangemaakt. Het **Nieuw**-menu op de desktop biedt dezelfde items in dezelfde volgorde.
...
Direct onder de dagnotitie staat **Journaal**: de items van de gekozen dag, een veld dat precies in die dag schrijft, en **Alle dagen**, dat het journaalscherm met de stroom van alle dagen opent. **＋** biedt **Journaalitem** aan vanaf overal — zie [Journaal](Journal.md).
...
De agenda's die je telefoon al kent verbind je zonder aanmelding: **Instellingen → Cloudaccounts → Account verbinden…** biedt **Op dit apparaat** als eerste tegel aan zolang er nog geen apparaataccount is. Een tik vraagt de systeemtoestemming; daarna staan alle agenda's van het apparaat in de lijst en op iOS de herinneringslijsten als takenlijsten. De accountkaart toont de stand van de toestemming en leidt naar de systeeminstellingen als die ontbreekt; **Account verwijderen** verbreekt alleen de koppeling, de agenda's van het apparaat blijven.
...
Onder **Inhoud** staat naast **Kluis exporteren** nu ook de **automatische vault-back-up**: eenmaal per dag een ZIP van de hele kluis, waarvan de laatste **zeven** worden bewaard (**Te bewaren back-ups**); **Nu back-uppen** maakt er meteen een. De archieven staan in de documenten van het apparaat, niet in de cache — iets wat het besturingssysteem op elk moment mag leegmaken, is geen archief. Een telefoon krijgt geen achtergrondwekker: de controle gebeurt bij het openen en telkens wanneer je terugkeert naar de app, dus haalt de back-up dat in plaats van op een vast tijdstip te draaien. De regel onder de schakelaar geeft daarom aan wanneer de laatste back-up is gemaakt — zo wordt een back-up die stilletjes nooit plaatsvindt, alsnog zichtbaar. Tot nu toe had mobiel alleen de handmatige export — een kluis waarvan niemand aan exporteren dacht, had daardoor helemaal geen archief. Na een herinstallatie op Android kan de telefoon zijn oudere archieven niet meer lezen — ze blijven in de map, maar worden niet meegeteld en niet opgeruimd; de kaart **Oudere back-ups zijn niet leesbaar** zegt dat, in plaats van "0 back-ups" te beweren. Een archiefmap die deze installatie niet kan lezen verschijnt als **Oudere back-ups zijn niet leesbaar**, nooit als „0 back-ups”.
...
**Een bestaande map als vault (Android en iOS).** Onder **Vaults → Vault aanmaken** is er een derde weg, **Een map op dit apparaat**: je kiest een map die een ander programma bijhoudt — Syncthing, de Bestanden-app, een tweede synchronisatieclient — en Plainva leest en schrijft daar zonder iets te kopiëren. De map blijft de map: verwijder je de vault, dan verdwijnt alleen de verbinding, de bestanden blijven. Wijzigingen die een ander programma daar maakt, ziet Plainva bij terugkeer in de app en bij het openen van een notitie. Cloudsynchronisatie staat voor zulke vaults uit — een tweede synchronisatie op dezelfde opslag zou de eerste overschrijven — en de kaart in het vaultdetail zegt dat. Verloopt de toegang (map verplaatst, toestemming ingetrokken), dan meldt de kaart het en **Map opnieuw verbinden** herstelt hem.
...
**Veeg een regel naar links** om de acties te tonen: **Bladwijzer** en **Verwijderen** bij een notitie, **Naam wijzigen** en **Verwijderen** bij een map, **Verwijderen** bij een database en in de postbus. Het zijn dezelfde acties die de regel ook in haar menu biedt (lang drukken) — vegen is alleen de kortere weg ernaartoe, nooit de enige. De eerste keer meldt een balk boven de lijst dat; je tikt hem weg, en hij verschijnt precies één keer per vault. **In de kalender** bladert een veeg naar links of rechts naar de volgende of vorige periode (dag, drie dagen, week, maand); een sleep die verticaal begint scrolt zoals gewoonlijk, en de chiprij erboven scrolt op zichzelf.
