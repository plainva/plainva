...
- **＋** zweeft als ronde knop boven de balk en opent snel aanmaken in twee groepen: notitie, "Vanuit sjabloon…", dagnotitie, map, database — en daaronder afspraak en taak, die in de agenda en de takenlijst worden aangemaakt. Het **Nieuw**-menu op de desktop biedt dezelfde items in dezelfde volgorde.
