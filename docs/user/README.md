# Plainva Nutzerhandbuch / User Guide

**[Deutsch](de/README.md)** | **[English](en/README.md)** | **[Français](fr/README.md)** | **[Español](es/README.md)** | **[Português (Brasil)](pt-BR/README.md)** | **[Italiano](it/README.md)** | **[Nederlands](nl/README.md)** | **[Polski](pl/README.md)** | **[简体中文](zh-CN/README.md)** | **[日本語](ja/README.md)**

---

Das Nutzerhandbuch liegt pro Sprache in einem eigenen Ordner (`de/`, `en/`, …). Alle Sprachordner enthalten dieselben Dateinamen; nur die Inhalte sind übersetzt.

The user guide lives in one folder per language (`de/`, `en/`, …). All language folders contain the same file names; only the contents are translated.
