...
- **RSVP i odpowiedzi**: gdy zostałeś zaproszony na wydarzenie, okno dialogowe udostępnia przyciski **Akceptuj**, **Wstępnie** i **Odrzuć** — Plainva wysyła Twoją odpowiedź do dostawcy (Google/Microsoft/CalDAV). **Lista uczestników** pokazuje, kto zaakceptował, a kto odrzucił (kanał zwrotny). Wysyłanie zaproszeń e-mailem na dowolne adresy jest funkcją klienta poczty.
