...
Otwórz mapę przez **Ctrl/Cmd+Shift+G**, przez ikonę grafu na **pasku akcji** po lewej stronie, lub przez paletę poleceń (**Otwórz graf**). Otwiera się we własnej karcie. Zamiast kłębka zobaczysz swoją rzeczywistą strukturę folderów jako bąbelki — podwójne kliknięcie bąbelka rozwija folder w **okrąg-kontener**, który obejmuje jego notatki i podfoldery; rozwinięte podfoldery zagnieżdżają się w nim jak na mapie. Podwójne kliknięcie **obrzeża okręgu** zwija folder z powrotem, **Zwiń wszystkie foldery** zamyka wszystko. Okrąg zawsze podąża za swoją zawartością: przenieś notatki do jego wnętrza, a urośnie razem z nimi; przeciągnij obrzeże, a folder przesunie się razem ze swoją zawartością. Wewnątrz okręgu notatki nadal układają się według swoich połączeń, a krawędzie prowadzą bezpośrednio od notatki do notatki. Układ jest deterministyczny: ta sama mapa wygląda tak samo za każdym razem, gdy ją otwierasz. **Przesuwaj mapę** środkowym przyciskiem myszy lub Ctrl/Cmd+przeciągnięciem, a **powiększaj i pomniejszaj** kółkiem myszy. Przeciągnij węzeł, a zostanie przypięty (mała kropka). W prawym górnym rogu **igła przypięcia** włącza i wyłącza zapamiętywanie: wyłącz ją, a zapamiętany układ tego widoku zostanie odrzucony i wróci automatyczny układ (tak samo jak **Resetuj układ** w menu kontekstowym). Przypięcia są przechowywane per urządzenie.
