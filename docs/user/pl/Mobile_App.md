...
- **＋** unosi się jako okrągły przycisk nad paskiem i otwiera szybkie tworzenie w dwóch grupach: notatka, „Z szablonu…”, notatka dzienna, folder, baza danych — a poniżej wydarzenie i zadanie, tworzone w kalendarzu i na liście zadań. Menu **Nowy** na komputerze oferuje te same pozycje w tej samej kolejności.
