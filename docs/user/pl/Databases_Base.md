...
- **Szybkie tworzenie**: pole **Napisz notatkę…** nad tablicą tworzy nową notatkę w folderze zapisu bazy danych po naciśnięciu Enter — bez szablonu, bez okrężnych dróg; wpisany tekst staje się treścią, a nazwa pliku pochodzi z jego pierwszych słów.
