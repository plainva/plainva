...
- **RSVP e respostas**: quando você foi convidado para um evento, o diálogo permite **Aceitar**, marcar como **Provisório** ou **Recusar** — o Plainva envia sua resposta ao provedor (Google/Microsoft/CalDAV). A **lista de participantes** mostra quem aceitou ou recusou (o canal de retorno). Enviar convites por e-mail para endereços arbitrários vem com o cliente de e-mail.
