...
- **Confirmación de asistencia (RSVP)**: cuando te invitaron a un evento, el diálogo te permite **Aceptar**, marcar **Provisional** o **Rechazar** — Plainva envía tu respuesta a través del proveedor (Google/Microsoft/CalDAV). La **lista de asistentes** muestra quién aceptó o rechazó (el canal de retorno). Enviar invitaciones por correo electrónico a direcciones arbitrarias es tarea del cliente de correo.
