...
La forma más rápida de entrar en la nota de hoy es el **diario**: `Ctrl+Shift+J` toma una línea, marca la hora y la añade bajo el encabezado **Journal** de la nota diaria de hoy — sin abrir la nota. **Abrir diario** en la barra de acciones muestra las entradas de todos los días como un flujo. Ver [Diario](Journal.md).
...
- **Colorear etiquetas**: en **Configuración → App → Apariencia**, activa **Colorear etiquetas** y cada etiqueta recibe un color que se deriva de su nombre — las etiquetas anidadas comparten el color de su etiqueta superior — en notas, propiedades, bases de datos y la lista de etiquetas. Desactivado de forma predeterminada; se aplica a este dispositivo y no guarda nada.
