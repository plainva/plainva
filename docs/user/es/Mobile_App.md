...
- **＋** flota como un botón redondo sobre la barra y abre la creación rápida en dos grupos: nota, «Desde plantilla…», nota diaria, carpeta, base de datos — y debajo evento y tarea, que se crean en el calendario y en la lista de tareas. El menú **Nuevo** del escritorio ofrece las mismas entradas en el mismo orden.
