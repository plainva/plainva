...
**Cuentas de correo sin contraseña.** Una configuración que falló al guardar podía dejar una entrada sin contraseña (Plainva 0.8.3 en el escritorio). El área **Correo** señala una vez las cuentas que no tienen contraseña en este dispositivo y que aquí nunca han recibido correo. **Ver** muestra la lista. Si usas una de esas cuentas en otro dispositivo, elige **Iniciar sesión en este dispositivo**: ese es entonces el camino correcto. **Quitar** elimina la entrada tras preguntar, en todos los dispositivos que sincronizan los ajustes de este vault, nunca correos ni archivos. **Más tarde** oculta el aviso. Plainva nunca quita nada por su cuenta.
...
Selecciona varios mensajes para marcarlos como leídos o no leídos, moverlos o eliminarlos. Los cambios confirmados actualizan la lista. Los mensajes sin confirmar siguen seleccionados y tienen un informe individual. Cancelar detiene el proceso después del lote actual. Recarga la carpeta antes de repetir una acción de resultado incierto. Si el servidor no permite una operación selectiva, Plainva lo explica y conserva los demás mensajes.

**Con adjuntos** filtra los mensajes cargados. El aviso indica cuántos tienen metadatos conocidos. La ausencia de metadatos no significa que no haya adjuntos; otras páginas pueden contener más resultados.

En un teclado físico móvil, Arriba/Abajo e Inicio/Fin mueven el foco en la lista. Intro abre el mensaje o lo selecciona. Izquierda/Derecha pliegan o despliegan conversaciones; Escape abandona la selección o cancela los lotes siguientes. Los campos de búsqueda mantienen sus teclas habituales.
