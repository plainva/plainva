...
- **Ánimo:** si el ajuste **Ánimo: propiedad de la nota diaria** (en el mismo lugar) lleva un nombre — por ejemplo `animo` —, el encabezado del día en el diario muestra cinco puntos y valoras el día con una pulsación. La nota diaria guarda entonces `animo: 4`; pulsar el valor actual lo borra. La misma propiedad puede ser una columna de tipo **Valoración** en una base de datos y ordenarse allí. Déjalo vacío y esta bóveda no valora días.
...
- **Lugar:** desactivado por defecto. Activa **Permitir añadir un lugar a las entradas del diario** (Ajustes → Apariencia) y el campo de captura gana un segundo botón; una pulsación añade tus coordenadas a la entrada en su propia línea: `📍 52.5200, 13.4050`. Cuatro decimales son unos once metros: bastan para el edificio, no para la habitación. Puedes escribir el nombre del lugar tú mismo o borrar la línea; Plainva no se lo pregunta a ningún servicio en línea. **No se registra nada en silencio**: sin historial, sin mapa, sin seguimiento en segundo plano, solo esa posición en el momento en que pulsas. El sistema pide permiso en la primera pulsación. En el teléfono el botón siempre está; en un ordenador solo donde el sistema operativo le da una posición a la aplicación.
