...
3. **Iniciar sesión** valida las credenciales; después elige la **Carpeta en la nube** mediante **Elegir carpeta…**.
...
Después de **Iniciar sesión**, la sincronización empieza de inmediato.
