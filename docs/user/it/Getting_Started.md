...
- **Tema personalizzato**: la scheda **Personalizzato** in **Impostazioni → App → Aspetto** apre un piccolo editor: tono di base (chiaro/scuro), uno sfondo entro un intervallo di luminosità, un accento libero, il carattere dell'interfaccia, gli angoli. Plainva deriva i colori del testo perché non sparisca mai nello sfondo; un accento troppo pallido viene corretto ad almeno 3:1 e l'editor lo dice. Sul telefono gli stessi controlli sono nella schermata **Aspetto**.
