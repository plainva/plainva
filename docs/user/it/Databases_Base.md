...
- **Cattura rapida**: il campo **Scrivi una nota…** sopra la bacheca crea una nuova nota nella cartella di archiviazione del database quando premi Invio — nessun modello, nessuna deviazione; il testo digitato è il contenuto e il nome del file deriva dalle sue prime parole.
