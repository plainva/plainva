...
- **Generazione** — sempre su tua azione, mai dal nulla: clic destro su una cartella → **Crea panoramica** / **Aggiorna panoramica**, oppure in blocco tramite la **Gestione index.md** (**Impostazioni → Vault → Contenuto e struttura**).
