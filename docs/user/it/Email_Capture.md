...
- **Con la tastiera nell'elenco** — Freccia su/giù seleziona il messaggio precedente/successivo e lo mostra nel lettore, Maiusc+freccia estende la selezione, Home/Fine saltano al primo/ultimo messaggio, freccia sinistra/destra comprime/espande una conversazione, Invio apre il messaggio nel lettore, Canc lo sposta nel cestino (con la stessa conferma del pulsante). Tutte le scorciatoie sono elencate nella finestra delle scorciatoie (F1) sotto **E-mail**.
