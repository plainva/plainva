...
- **＋** fluttua come un pulsante rotondo sopra la barra e apre la creazione rapida in due gruppi: nota, "Da modello…", nota giornaliera, cartella, database — e sotto evento e attività, creati nel calendario e nell'elenco attività. Il menu **Nuovo** del desktop offre le stesse voci nello stesso ordine.
