...
- **RSVP et réponses** : lorsque vous êtes invité à un événement, la boîte de dialogue permet de cliquer sur **Accepter**, de marquer **Provisoire** ou de **Refuser** — Plainva envoie votre réponse au fournisseur (Google/Microsoft/CalDAV). La **liste des participants** indique qui a accepté ou refusé (le canal retour). L'envoi d'invitations par e-mail à des adresses arbitraires se fait via le client de messagerie.
