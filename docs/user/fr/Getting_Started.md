...
- **Thème personnalisé** : la carte **Mon thème** sous **Paramètres → App → Apparence** sélectionne le thème, et le crayon dessus ouvre sa page : ambiance (clair/sombre), un fond dans une plage de luminosité bornée, un accent libre, la police de l'interface, les angles. Plainva dérive les couleurs du texte pour qu'il ne disparaisse jamais dans le fond ; un accent trop pâle est corrigé à 3:1 au minimum, et l'éditeur le dit. Sur le téléphone, les mêmes réglages sont dans l'écran **Apparence**.
