...
- **Les listes se poursuivent d'elles-mêmes** (Entrée insère la marque de liste suivante), les blocs de code bénéficient d'une coloration syntaxique selon le langage, le contenu collé est converti en Markdown (collage intelligent), et les titres peuvent être repliés.
