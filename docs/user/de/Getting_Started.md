...
**Community-Paket für Arch Linux:** [plainva im AUR](https://aur.archlinux.org/packages/plainva) wird unabhängig gepflegt. Prüfe das PKGBUILD vor dem Bauen; diese Community-Builds werden nicht vom Plainva-Projekt geprüft. Die Anwendung bleibt unter AGPL-3.0-only lizenziert.
...
- **Neuer Vault** — zuerst kommt die Frage **„Wo soll Dein Vault liegen?"** (**Auf diesem Computer** oder **Bei einem Online-Dienst**), danach wählst Du die Startstruktur: leer oder mit einer vorbereiteten Ordnerstruktur; beides ist jederzeit anpassbar. Der **Leere Vault** enthält nur eine `index.md`-Übersicht. Als Vorlagen stehen die **Plainva-Tour**, **PARA**, **Zettelkasten**, **ACE (Linking Your Thinking)**, **Johnny.Decimal**, **GTD**, **Journal** und **Projekt** bereit — jede legt Ordner, eine Willkommensnotiz mit Kurzanleitung und automatisch gepflegte `index.md`-Übersichten im [OKF-Format](OKF.md) an (Ordner- und Dateinamen folgen der App-Sprache). Die **Plainva-Tour** ist als Einstieg empfohlen: Sie füllt zehn Ordner und sieben Datenbanken mit Beispielen, sodass Du jede Ansicht einmal in Betrieb siehst — Pinnwand, Kalender, Galerie, Board, Graph, Zeitleiste, Tabelle und die Baum-Ansicht mit Unterelementen — dazu Notiz-Vorlagen, Ordner-Regeln und einen Markdown-Spickzettel. Hier ist nichts kostbar: Lösche, was Du nicht brauchst, und benenne den Rest um. Die **Journal**-Vorlage richtet zusätzlich die Tagesnotizen-Einstellungen des Vaults gleich mit ein. Die Vorlagen **Plainva-Tour**, **PARA**, **GTD**, **Zettelkasten**, **Journal** und **Projekt** bringen außerdem fertig verknüpfte [Datenbanken](Databases_Base.md) samt Notiz-Vorlagen mit — etwa Projekte mit Status-Board und Bereichs-Bezug oder Aufgaben, die auf ihr Projekt verweisen. Die **Projekt**-Vorlage zeigt das Projektwerkzeug in Betrieb: vier verbundene Datenbanken, eine Spalte, die die offenen Aufgaben eines Projekts zählt, eine Fußzeile, die den geplanten Aufwand summiert, Abhängigkeiten zwischen Aufgaben und Meilensteine, die in der Zeitleiste als Raute erscheinen. Beim Online-Weg folgt nach der Vorlage die Verbindung: Anbieter wählen, verbinden, den Ordner in der Cloud wählen oder über **Neuer Ordner** frisch anlegen, lokalen Ordner wählen — die gewählte Struktur entsteht im lokalen Ordner und wird beim ersten Sync in die Cloud hochgeladen.
...
## Plainva Tour · Übersicht

Beginne mit der ersten kleinen Übung oder öffne unten direkt eine Datenbank. Die ersten fünf Stationen zeigen den Alltag; alles Weitere ist freiwillig. Für einen ersten Einblick kannst Du etwa 10–15 Minuten einplanen und Dir zum Ausprobieren beliebig mehr Zeit nehmen. Alle Beispiele sind erfunden und dürfen verändert werden.

**Öffnen:** `Tour/01 Schreiben und verknüpfen.md`

1. Schreiben und verknüpfen
2. Aus einer Notiz wird eine Aufgabe
3. Ein Projekt planen
4. Finden und ordnen
5. Einen Tag gestalten
6. Eine Notiz besprechen
7. Versionen vergleichen und Dateien behalten
8. Entdecken, was Dir hilft
9. Konten, Geräte und Import
10. Teilen und automatisieren

Das synthetische Paket enthält genau zwei Notizen mit dem Tag tour-import und keine gelöschten Notizen. Der Bericht sollte zwei importierte Notizen zeigen; die Tour-Dateien bleiben getrennt. Zum Rückgängigmachen kannst Du nur diesen neu angelegten Unterordner löschen.

Verschlüsselte Workspaces und ihre Freigaben sind experimentell und benötigen echte Identitäten, Schlüssel und einen verbundenen Dienst. Erkunde Rollen, Einladungen und Veröffentlichungen mit getrennten Demodaten. Automatisierung und Skripte verlangen bewusste Einrichtung und Berechtigungen; die Vorlage startet kein Skript, kontaktiert keinen Dienst, erzeugt keine Zugangsdaten und täuscht keine Freigabe vor. Wähle bei Bedarf einen kleinen Ablauf aus dem Handbuch.

Tour-Datenversion: 2026-09-11. Die Beispieldaten beziehen sich auf den Tag der Vault-Erstellung. Vorlagenupdates gelten ausschließlich für künftig neue Vaults; dieser Vault wird dadurch niemals verändert oder ergänzt.

Wähle einen neuen, leeren lokalen Ordner und bei einer Online-Neuanlage einen leeren Cloudordner. Bestehende Vaults werden ohne Anwendung einer Vorlage geöffnet. Das Entfernen von Dateien oder ein Gerätewechsel macht einen bestehenden Vault niemals zum Ziel eines Vorlagenupdates.
...
- **Tags einfärben**: Unter **Einstellungen → App → Erscheinungsbild** schaltest Du **Tags einfärben** ein, und jeder Tag bekommt eine Farbe, die aus seinem Namen folgt — verschachtelte Tags teilen die Farbe ihres obersten Tags — in Notizen, Eigenschaften, Datenbanken und der Tag-Liste. Standardmäßig aus; gilt für dieses Gerät und speichert nichts.
- **Eigenes Design**: Die Karte **Mein Design** unter **Einstellungen → App → Erscheinungsbild** wählt das Design, der Stift darauf öffnet dessen Seite: Grundstimmung (hell/dunkel), Hintergrund aus einem begrenzten Helligkeitsbereich, Akzent frei, Rundung (die Schriften wählt die Karte **Schrift** auf derselben Seite). Textfarben leitet Plainva ab, damit Schrift nie im Hintergrund verschwindet; ein zu blasser Akzent wird auf mindestens 3:1 korrigiert, und der Editor sagt das. Am Telefon dieselben Regler im Bildschirm **Erscheinungsbild**. Helle und dunkle Stimmung haben eigene Farben, die Rundung gilt für beide. Eine bisher gespeicherte Stimmung bleibt erhalten. Die Gegenstimmung ist zunächst nur ein Vorschlag und wird erst mit **Stimmung übernehmen** gespeichert. Mit beiden Stimmungen wechselt **System** passend zum Gerät.
- **Persönlicher Design-Abgleich**: Auf der Seite **Mein Design** kannst Du **Über diesen Vault abgleichen** ausdrücklich einschalten. Wähle dafür auf jedem Gerät einen entsperrten Vault; die Synchronisierung der Einstellungen muss aktiv sein. Genau ein Vault dient als Quelle für Dein eigenes Design. Andere Mitglieder erhalten keinen Designzwang. Ist schon ein Design angekommen, wird dieses übernommen; sonst wird Dein lokales Design bereitgestellt. Bei gleichzeitigen Änderungen bleiben beide Varianten zur Auswahl erhalten. Ausschalten behält Dein lokales Design. Schriften und die Auswahl eines anderen Designs werden dadurch nicht synchronisiert.
...
## Eine To-do-Liste über Deinen Notizen

Die [Aufgabenansicht](Tasks.md) macht aus den Checkboxen in Deinen Notizen und den Einträgen Deiner Aufgaben-Datenbank eine To-do-Liste: **Heute** mit dem Überfälligen obenauf, **Demnächst**, **Eingang** und **Erledigt**. Ein Erfassungsfeld versteht einen ganzen Satz — `Zahnarzt anrufen morgen 9:30 !!` — und zeigt, was es verstanden hat, bevor es etwas speichert.
