...
- **Linke Seitenleiste** — drei Ansichten: **Dateien** (der Dateibaum), **Tags** (alle `#tags` im Vault) und **Lesezeichen**. Oben sitzt der große **Neu**-Knopf (Neue Notiz, daneben **Weitere Optionen** für Neuer Ordner, Neue Base, Tageseintrag). Unten: Vault-Wechsler, **Tägliche Notiz öffnen** und **Einstellungen**.
