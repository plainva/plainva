...
- **Zu-/Absagen & Antworten**: Wurdest Du zu einem Termin eingeladen, kannst Du im Dialog **Zusagen**, **Vorläufig** oder **Absagen** — Plainva sendet Deine Antwort über den Anbieter (Google/Microsoft/CalDAV). Die **Teilnehmerliste** zeigt, wer zu- oder abgesagt hat (der Rückkanal). Einladungen per E-Mail an beliebige Adressen zu verschicken kommt mit dem Mailclient.
