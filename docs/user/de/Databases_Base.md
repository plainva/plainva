...
- **Schnell erfassen**: Das Eingabefeld **Notiz schreiben…** über dem Brett legt mit der Eingabetaste einen neuen Zettel im Ablage-Ordner der Datenbank an — ohne Vorlage, ganz ohne Umwege; der getippte Text ist der Inhalt, der Dateiname entsteht aus den ersten Worten.
