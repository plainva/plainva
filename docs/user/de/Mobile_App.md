...
- **Alle Bereiche** erreichst Du jederzeit über das **Bereichs-Blatt**: über **Bereiche** in der Leiste oder **langes Drücken auf die Leiste**. Es zeigt DEINE Anordnung — die Bereiche der Leiste zuerst, dann die übrigen, in der Reihenfolge, die Du gewählt hast —, markiert den aktuellen und führt unten direkt zu **Navigationsleiste anpassen…**. Tags, Lesezeichen und Zuletzt geöffnet sind keine eigenen Bereiche mehr — sie liegen unter **Notizen**.
- **Navigationsleiste einstellen:** **Einstellungen** → **Leisten & Bereiche**. Mit **−**/**+** legst Du fest, wie viele Arbeitsflächen die Leiste zeigt (2–4, mit Live-Vorschau). Jede Zeile antwortet: Ein Tipp holt den Bereich in die Leiste oder nimmt ihn heraus, das **Auge** daneben sagt, was gerade gilt, und der **Zieh-Griff** ordnet um — am oberen und unteren Rand scrollt die Liste beim Ziehen mit, so reicht eine Bewegung über die ganze Liste. Ausgeblendet ist nichts verloren: Was nicht in der Leiste steht, bleibt über **Bereiche** erreichbar. Verlässt der gerade offene Bereich die Leiste, springt die App auf den ersten sichtbaren. Dieselbe Leiste kannst Du auch **am Desktop** anordnen (Einstellungen → Vault → Leisten & Bereiche); mit eingeschaltetem Einstellungs-Sync reist die Anordnung zwischen Deinen Geräten mit.
...
- **＋** schwebt als runder Knopf über der Leiste und öffnet die Schnellanlage in zwei Gruppen: Notiz, „Aus Vorlage…", Tagesnotiz, Journal-Eintrag, Ordner, Datenbank — und darunter Termin und Aufgabe, die im Kalender beziehungsweise in der Aufgabenliste angelegt werden. Dieselben Einträge in derselben Reihenfolge bietet am Desktop das **Neu**-Menü.
...
Direkt unter der Tagesnotiz steht **Journal**: die Einträge des gewählten Tages, ein Feld, das genau in diesen Tag schreibt, und **Alle Tage**, das den Journal-Bildschirm mit dem Strom aller Tage öffnet. **＋** bietet **Journal-Eintrag** von überall an — siehe [Journal](Journal.md).
