...
On the phone the same threads sit in a sheet rather than a column, and tapping the quoted piece jumps to it in the note. Reading, replying, resolving and deciding on suggestions all work there too — starting a comment or a suggestion on a passage does not yet; that needs the desktop. **Make a task** is there as well.
